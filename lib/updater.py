...
SHOW_CUSTOM_UPDATER_OPTION = True  # Control whether the "custom" option shows up in the update source setting
...
CUSTOM_UPDATER_REPO = "Demonseed-jpg/plex-for-kodi"  # Set the Github repo for the custom repository
CUSTOM_UPDATER_BRANCH = "ppi-update"  # Set the branch for the custom repository
